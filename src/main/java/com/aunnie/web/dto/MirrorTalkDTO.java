...
public class MirrorTalkDTO {
	...
	private int t_writer_no;
	private String t_contents;
	private String t_img_path;
	
	public MirrorTalkDTO(){}

	public MirrorTalkDTO(int talk_no, int t_like, int t_views, String t_title, int t_writer_no, String t_contents,
			String t_img_path) {
		super();
	...
	public int getT_writer_no() {
		return t_writer_no;
	}

	public void setT_writer_no(int t_writer_no) {
		this.t_writer_no = t_writer_no;
	}
